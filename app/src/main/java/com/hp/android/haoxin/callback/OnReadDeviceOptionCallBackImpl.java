        ...
        if (lastProgressResponse != data[1]) { //和上一次命令不一样时（否则相同参数动画不连贯）
            ...
            switch (data[1]) {
                case Response.Progress.PROGRESS_SAFFRON:
                    ...
                    call.workStartDiskColorAnimation(SpoutView.RED_COLOR, 2000, 0, 180); //颜色渐变
                    break;
                case Response.Progress.PROGRESS_ALCOHOL:
                    ...
                    call.workStartDiskColorAnimation(SpoutView.WHITE_COLOR, 2000, 0, 180); //颜色渐变
                    break;
                ...
                case Response.Progress.PROGRESS_METHYLENE_BLUE:
                    ...
                    call.workStartSpout(SpoutView.C, SpoutView.BLUE);
                    call.workStartDiskColorAnimation(SpoutView.BLUE_COLOR, 2000, 0, 180); //颜色渐变
                    break;
